...
| LLM Reasoning Service | Builds grounded prompts, calls the local MLX deployment of `LiquidAI/LFM2.5-1.2B-Instruct`, and validates response structure. | `8002` |
